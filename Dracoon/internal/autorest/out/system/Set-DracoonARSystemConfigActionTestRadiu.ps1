function Set-DracoonARSystemConfigActionTestRadiu {
<#
.SYNOPSIS
...
.EXAMPLE
    PS C:\> Set-DracoonARSystemConfigActionTestRadiu -Connection $connection
...
#>
    ...
    process {
        ...
        $__path = 'system/config/actions/test/radius'
