function Remove-DracoonARSystemConfigAuthAd {
<#
.SYNOPSIS
...
.EXAMPLE
    PS C:\> Remove-DracoonARSystemConfigAuthAd -Connection $connection -Ad_id $ad_id
...
#>
    ...
    process {
        ...
        $__path = 'system/config/auth/ads/{ad_id}' -Replace '{ad_id}',$Ad_id
