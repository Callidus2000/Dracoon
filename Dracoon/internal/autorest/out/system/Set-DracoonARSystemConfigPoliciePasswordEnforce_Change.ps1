function Set-DracoonARSystemConfigPoliciePasswordEnforce_Change {
<#
.SYNOPSIS
...
.EXAMPLE
    PS C:\> Set-DracoonARSystemConfigPoliciePasswordEnforce_Change -Connection $connection
...
#>
    ...
    process {
        ...
        $__path = 'system/config/policies/passwords/enforce_change'
