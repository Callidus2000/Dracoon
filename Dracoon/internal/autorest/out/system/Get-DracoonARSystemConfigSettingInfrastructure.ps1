function Get-DracoonARSystemConfigSettingInfrastructure {
<#
.SYNOPSIS
...
.EXAMPLE
    PS C:\> Get-DracoonARSystemConfigSettingInfrastructure -Connection $connection
...
#>
    ...
    process {
        ...
        $__path = 'system/config/settings/infrastructure'
