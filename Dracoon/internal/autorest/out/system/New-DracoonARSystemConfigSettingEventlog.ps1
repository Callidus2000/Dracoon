function New-DracoonARSystemConfigSettingEventlog {
<#
.SYNOPSIS
...
.EXAMPLE
    PS C:\> New-DracoonARSystemConfigSettingEventlog -Connection $connection
...
#>
    ...
    process {
        ...
        $__path = 'system/config/settings/eventlog'
