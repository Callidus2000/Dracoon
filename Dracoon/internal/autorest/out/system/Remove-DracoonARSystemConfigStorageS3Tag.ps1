function Remove-DracoonARSystemConfigStorageS3Tag {
<#
.SYNOPSIS
    Remove S3 tag
...
.EXAMPLE
    PS C:\> Remove-DracoonARSystemConfigStorageS3Tag -Id $id -Connection $connection
...
#>
    ...
    process {
        ...
        $__path = 'system/config/storage/s3/tags/{id}' -Replace '{id}',$Id
