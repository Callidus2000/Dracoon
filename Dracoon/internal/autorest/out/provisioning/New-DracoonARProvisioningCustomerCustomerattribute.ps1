function New-DracoonARProvisioningCustomerCustomerattribute {
<#
.SYNOPSIS
...
.EXAMPLE
    PS C:\> New-DracoonARProvisioningCustomerCustomerattribute -Customer_id $customer_id -Connection $connection
