function Get-DracoonARProvisioningWebhook {
<#
.SYNOPSIS
...
.EXAMPLE
    PS C:\> Get-DracoonARProvisioningWebhook -Connection $connection
...
.EXAMPLE
    PS C:\> Get-DracoonARProvisioningWebhook -Webhook_id $webhook_id
...
#>
    ...
    param (
        ...
        [Parameter(ValueFromPipelineByPropertyName = $true, ParameterSetName = 'default')]
        [Parameter(ValueFromPipelineByPropertyName = $true, ParameterSetName = 'requestTenantWebhook')]
        [object]
        $XSdsDateFormat,
        ...
        [Parameter(Mandatory = $true, ValueFromPipelineByPropertyName = $true, ParameterSetName = 'requestTenantWebhook')]
        [string]
        $Webhook_id
    )
    process {
