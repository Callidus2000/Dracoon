function Get-DracoonARGroupRoom {
<#
.SYNOPSIS
...
.EXAMPLE
    PS C:\> Get-DracoonARGroupRoom -Connection $connection -Group_id $group_id
...
#>
    ...
    process {
        ...
        $__path = 'groups/{group_id}/rooms' -Replace '{group_id}',$Group_id
