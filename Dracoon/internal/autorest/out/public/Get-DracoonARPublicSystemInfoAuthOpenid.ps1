function Get-DracoonARPublicSystemInfoAuthOpenid {
<#
.SYNOPSIS
...
.EXAMPLE
    PS C:\> Get-DracoonARPublicSystemInfoAuthOpenid -Connection $connection
...
#>
    ...
    process {
        ...
        $__path = 'public/system/info/auth/openid'
