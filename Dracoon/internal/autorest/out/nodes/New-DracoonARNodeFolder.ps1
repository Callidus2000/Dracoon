function New-DracoonARNodeFolder {
<#
.SYNOPSIS
...
.EXAMPLE
    PS C:\> New-DracoonARNodeFolder -Connection $connection -Folder_id $folder_id
...
#>
    ...
    process {
        ...
        $__path = 'nodes/folders/{folder_id}' -Replace '{folder_id}',$Folder_id
