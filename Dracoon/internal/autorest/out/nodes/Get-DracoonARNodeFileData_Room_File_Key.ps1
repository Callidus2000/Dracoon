function Get-DracoonARNodeFileData_Room_File_Key {
<#
.SYNOPSIS
...
.EXAMPLE
    PS C:\> Get-DracoonARNodeFileData_Room_File_Key -File_id $file_id -Connection $connection
...
#>
    ...
    process {
        ...
        $__path = 'nodes/files/{file_id}/data_room_file_key' -Replace '{file_id}',$File_id
