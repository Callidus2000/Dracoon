function Get-DracoonARNodeRoomEvent {
<#
.SYNOPSIS
...
.EXAMPLE
    PS C:\> Get-DracoonARNodeRoomEvent -Connection $connection -Room_id $room_id
...
#>
    ...
    process {
        ...
        $__path = 'nodes/rooms/{room_id}/events' -Replace '{room_id}',$Room_id
