function Get-DracoonARConfigInfoNotificationChannel {
<#
.SYNOPSIS
...
.EXAMPLE
    PS C:\> Get-DracoonARConfigInfoNotificationChannel -Connection $connection
...
#>
    ...
    process {
        ...
        $__path = 'config/info/notifications/channels'
