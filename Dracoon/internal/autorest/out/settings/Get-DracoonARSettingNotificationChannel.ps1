function Get-DracoonARSettingNotificationChannel {
<#
.SYNOPSIS
...
.EXAMPLE
    PS C:\> Get-DracoonARSettingNotificationChannel -Connection $connection
...
#>
    ...
    process {
        ...
        $__path = 'settings/notifications/channels'
